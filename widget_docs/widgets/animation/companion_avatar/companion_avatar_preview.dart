...
import 'package:flutter_custom_widget_docs/widgets/animation/companion_avatar.dart';
import 'package:flutter_custom_widget_docs/widgets/animation/companion_avatar.doc_widget.dart';

import '../../preview/device_frame_switcher.dart';
import '../../preview/preview_screen.dart';
import '../../preview/demo_host.dart';

final _documentation = CompanionAvatarDocWidget();

final companionAvatarPreview = ElementPreview(
...
final _previews = renderPreview(
  ...
  description:
      "An emoji character sitting in a gradient well: it breathes continuously, and on tap it bounces, tilts and bursts confetti. The breath is ambient — identical at level 1 and level 20 — so its presence carries no information and a remount replays nothing. The tap is the opposite: input-triggered, once per finger, never per rebuild. Set `interactive` to false and it becomes a still figure for use in lists.",
  dependencies: _documentation.dependencies,
  code: r'''
CompanionAvatar(emoji: '🦊', size: 140, onTap: () {}),
  ''',

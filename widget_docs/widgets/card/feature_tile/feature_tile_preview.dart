...
import 'package:flutter_custom_widget_docs/widgets/cards/feature_tile.dart';
import 'package:flutter_custom_widget_docs/widgets/cards/feature_tile.doc_widget.dart';

import '../../preview/device_frame_switcher.dart';
import '../../preview/preview_screen.dart';
import '../../preview/demo_host.dart';

final _documentation = FeatureTileDocWidget();

final featureTilePreview = ElementPreview(
...
final _previews = renderPreview(
  title: "Feature Tile",
  description:
      "Entry point to a feature: rounded square icon on a tinted background, title, subtitle, and a badge for work waiting inside. The whole tile is one tap target, not just the chevron on the right.",
  dependencies: _documentation.dependencies,
  code: r'''
FeatureTile(
  icon: Icons.medication_rounded,
  title: 'Medication reminders',
  subtitle: 'Three times a day',
  badgeCount: 2,
  onTap: () {},
),
  ''',
      ...
      child: Column(
        ...
        children: [
          FeatureTile(
            icon: Icons.medication_rounded,
            title: 'Medication reminders',
            subtitle: 'Three times a day at 8am, 1pm and 8pm',
            badgeCount: 2,
            onTap: () {},
          ),
          ...
          FeatureTile(
            ...
            subtitle: 'Not measured today',
            accent: CustomColors.reward,
            onTap: () {},
          ),
        ],
      ),

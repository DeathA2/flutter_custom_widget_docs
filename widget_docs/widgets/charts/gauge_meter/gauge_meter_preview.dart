...
import 'package:flutter_custom_widget_docs/widgets/charts/gauge_meter.dart';
import 'package:flutter_custom_widget_docs/widgets/charts/gauge_meter.doc_widget.dart';

import '../../preview/device_frame_switcher.dart';
import '../../preview/preview_screen.dart';
import '../../preview/demo_host.dart';

final _documentation = GaugeMeterDocWidget();

final gaugeMeterPreview = ElementPreview(
...
final _previews = renderPreview(
  title: "Gauge Meter",
  description:
      "A 270° gauge with the gap at the bottom and a knob riding the head of the arc. Every proportion is a fraction of `size`, so changing the size scales the whole assembly correctly instead of needing each number retuned. The tween is seeded from the last painted value, same as the progress bar.",
  dependencies: _documentation.dependencies,
  code: r'''
GaugeMeter(fraction: 0.68, centerLabel: '68'),
  ''',
  widget: DeviceFrameSwitcher(
    child: DemoSurface(
      child: Column(
        ...
        children: [
          const GaugeMeter(fraction: 0.68, centerLabel: '68', size: 180),
          const SizedBox(height: 16),
          GaugeMeter(
            fraction: 0.24,
            centerLabel: '24',
            size: 120,
            gradientColors: const [CustomColors.warning, CustomColors.error],
          ),
        ],
      ),
    ),
